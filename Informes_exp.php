                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label for="select-dddmultiple"
                                                            class="control-label mb-1">Abogado
                                                            Asignado<span class="required-field">*</span></label>
                                                        <select id="select-multiple" name="Abogado[]" multiple required>
                                                            <option value="" disabled selected>Seleccione a uno o más
                                                                abogados</option>
                                                            <?php
                                                            ...
                                                            if ($resultado->num_rows > 0) {
                                                                ...
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    ...
                                                                    echo '<option value="' . $fila['id'] . '">' . $fila['n_abogado'] . '</option>';
                                                                }
                                                            } else {
                                                                echo "No se encontraron registros en la tabla cat_abogado.";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" id="FechaVen" name="FechaVen" class="form-control"
                                                            style="font-size: 16px;" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="table-responsive m-b-40">
                                                <table class="table table-borderless table-data3">
                                                    <thead>
                                                        <tr>
                                                            <th>Abogado(s)</th>
                                                            <th>Expedientes pendientes</th>
                                                            <th>Expedientes concluidos</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (isset($_POST['Find'])) {
                                                            ...
                                                            $sql = "SELECT 
                                                                        ...
                                                                        SUM(CASE WHEN cat_estatus.estatus = 'CONCLUIDO' THEN 1 ELSE 0 END) AS total_concluidos,
                                                                        SUM(CASE WHEN cat_estatus.estatus != 'CONCLUIDO' THEN 1 ELSE 0 END) AS total_no_concluidos
                                                                    FROM 
                                                                        captura
                                                            ...
                                                            $sql .= " GROUP BY cat_abogado.n_abogado";
                                                            ...
                                                            if ($resultado->num_rows > 0) {
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    ...
                                                                    $total_concluidos = $fila['total_concluidos'];
                                                                    $total_no_concluidos = $fila['total_no_concluidos'];
                                                                    $total_expedientes = $total_concluidos + $total_no_concluidos;
                                                                    echo '<tr>
                                                                    <td>' . $abogado . '</td>
                                                                    <td class="denied">' . $total_no_concluidos . '</td>
                                                                    <td class="process">' . $total_concluidos . '</td>
                                                                    <td>' . $total_expedientes . '</td>
                                                                </tr>';
