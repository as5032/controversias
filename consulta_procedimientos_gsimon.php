                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="tabla-responsiva" style="max-height: 600px; overflow-y: auto;">
                                    ...
                                    <br>
                                    <table id="example" class="table table-striped table-bordered hover" style="width:80%">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT
                                                    ...
                                                    captura_2.observaciones
                                                FROM
                                                    captura_2
                                                LEFT JOIN cat_estatus ON captura_2.estatus = cat_estatus.id
                                                LEFT JOIN cat_abogado ON captura_2.abogado = cat_abogado.id
                                                LEFT JOIN cat_juicio ON captura_2.juicio_proced = cat_juicio.id
                                                LEFT JOIN cat_actor ON captura_2.actores = cat_actor.id
                                                LEFT JOIN cat_seguimiento ON captura_2.seguimiento = cat_seguimiento.id
                                                LEFT JOIN cat_prioridad ON captura_2.prioridad = cat_prioridad.id
                                                LEFT JOIN cat_ministro ON captura_2.ministro = cat_ministro.id
                                                WHERE
