...
<body>
                    ...
                    <div class="col-lg-12 h-100">
                        <div class="card h-100">
                            <div class="card-header" style="font-size: 25px;">
                                <strong>Consulta</strong> en trámite por años
                            </div>
                                    ...
                                    <form action="" method="POST" class="h-100" id="miFormulario" name="miFormulario" enctype="multipart/form-data">
                                        <div style="font-size: 17px;">
                                            <div align="center">
                                                ...
                                                <a href="#" style="text-decoration: underline" onclick="SubmitFormData('num_exp');" class="toggle-vis" data-column="5"># de Expediente</a> -
                                                <a href="#" style="text-decoration: underline" onclick="SubmitFormData('num_int');" class="toggle-vis" data-column="6"># Interno</a> -
                                                ...
                                                <a href="#" style="text-decoration: underline" onclick="SubmitFormData('actores');" class="toggle-vis" data-column="8">Actor/Demandado</a>
                                                <br>
                                                ...
                                                <br>
                                                <input type="button" onclick="SubmitFormData('2019');" class="btn btn-danger btn-lg" value="2019"/>
                                                <input type="button" onclick="SubmitFormData('2020');" class="btn btn-warning btn-lg" value="2020"/>
                                                <input type="button" onclick="SubmitFormData('2021');" class="btn btn-primary btn-lg" value="2021"/>
                                                <input type="button" onclick="SubmitFormData('2022');" class="btn btn-secondary btn-lg" value="2022"/>
                                                <input type="button" onclick="SubmitFormData('2023');" class="btn btn-info btn-lg" value="2023"/>
                                                <input type="button" onclick="SubmitFormData('2024');" class="btn btn-dark btn-lg" value="2024"/>                                                
                                            </div>
                                        </div>
                                        <br>
                                </div>
    ...
    <body>
        <script>
            ...
            function Refrescar() {
                document.miFormulario.action = 'consultas.php';
