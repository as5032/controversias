                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label for="select-dddmultiple"
                                                            class="control-label mb-1">Actor/Demandado<span
                                                                class="required-field">*</span></label>
                                                        <select id="select-multiple" name="Actor[]" multiple required>
                                                ...
                                                <table class="table table-borderless table-data3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (isset($_POST['Find'])) {
                                                            ...
                                                            $sql = "SELECT 
                                                                cat_actor.actord AS actor_nombre,
                                                            ...
                                                            if (!empty($_POST['Actor'])) {
                                                                $actor_seleccionados = $_POST['Actor'];
                                                                $actor_filtro = implode(",", $actor_seleccionados);
                                                                $sql .= " AND captura.actores IN ($actor_filtro)";
                                                            }
                                                            ...
                                                            $sql .= " GROUP BY cat_actor.actord";

                                                            $resultado = $conn->query($sql);

                                                            if ($resultado->num_rows > 0) {
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    $actor = $fila['actor_nombre'];
                                                                    $total_actor = $fila['total_actor'];
                                                                    echo '<tr>
                                                                    <td>' . $actor . '</td>
                                                                    <td class="denied">' . $total_actor . '</td>
                                                                </tr>';
