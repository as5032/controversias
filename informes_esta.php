                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label for="select-dddmultiple"
                                                            class="control-label mb-1">Estatus<span
                                                                class="required-field">*</span></label>
                                                        <select id="select-multiple" name="Estatus[]" multiple required>
                                                            <option value="" disabled selected>Seleccione uno o más
                                                                estatus</option>
                                                            <?php
                                                            ...
                                                            if ($resultado->num_rows > 0) {
                                                                ...
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    ...
                                                                    echo '<option value="' . $fila['id'] . '">' . $fila['estatus'] . '</option>';
                                                                }
                                                            } else {
                                                                echo "No se encontraron registros en la tabla cat_estatus.";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <table class="table table-borderless table-data3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (isset($_POST['Find'])) {
                                                            ...
                                                            $sql = "SELECT 
                                                                cat_estatus.estatus AS estatus_nombre,
                                                            ...
                                                            $sql .= " GROUP BY cat_estatus.estatus";

                                                            $resultado = $conn->query($sql);

                                                            if ($resultado->num_rows > 0) {
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    $estatus = $fila['estatus_nombre'];
                                                                    $total_expedientes = $fila['total_expedientes'];
                                                                    echo '<tr>
                                                                    <td>' . $estatus . '</td>
                                                                    <td class="denied">' . $total_expedientes . '</td>
                                                                </tr>';
                                                                    $showPrintButton = true; // Variable que indica que se encontraron datos
                                                                }
                                                            } else {
