                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="select-multiple" name="Juicio[]" multiple required>
                                                ...
                                                <table class="table table-borderless table-data3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (isset($_POST['Find'])) {
                                                            ...
                                                            $sql = "SELECT 
                                                                cat_juicio.t_juicio AS juicio_nombre,
                                                                COUNT(*) AS total_juicio
                                                            FROM 
                                                                captura
                                                            ...
                                                            if (!empty($_POST['Juicio'])) {
                                                                $juicio_seleccionados = $_POST['Juicio'];
                                                                $juicio_filtro = implode(",", $juicio_seleccionados);
                                                                $sql .= " AND captura.juicio_proced IN ($juicio_filtro)";
                                                            }
                                                            ...
                                                            $sql .= " GROUP BY cat_juicio.t_juicio";

                                                            $resultado = $conn->query($sql);

                                                            if ($resultado->num_rows > 0) {
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    $juicio = $fila['juicio_nombre'];
                                                                    $total_juicio = $fila['total_juicio'];
                                                                    echo '<tr>
                                                                    <td>' . $juicio . '</td>
                                                                    <td class="denied">' . $total_juicio . '</td>
                                                                </tr>';
