                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label for="select-dddmultiple"
                                                            class="control-label mb-1">Seguimiento<span
                                                                class="required-field">*</span></label>
                                                        <select id="select-multiple" name="Seguimiento[]" multiple required>
                                                            ...
                                                            if ($resultado->num_rows > 0) {
                                                                ...
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    ...
                                                                    echo '<option value="' . $fila['id'] . '">' . $fila['seguimiento'] . '</option>';
                                                                }
                                                            } else {
                                                ...
                                                <table class="table table-borderless table-data3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (isset($_POST['Find'])) {
                                                            ...
                                                            $sql = "SELECT 
                                                                cat_seguimiento.seguimiento AS seguimiento_nombre,
                                                            ...
                                                            if (!empty($_POST['Seguimiento'])) {
                                                                ...
                                                                $seguimiento_filtro = implode(",", $seguimientos_seleccionados);
                                                                $sql .= " AND captura.seguimiento IN ($seguimiento_filtro)";
                                                            }
                                                            ...
                                                            $sql .= " GROUP BY cat_seguimiento.seguimiento";

                                                            $resultado = $conn->query($sql);

                                                            if ($resultado->num_rows > 0) {
                                                                while ($fila = $resultado->fetch_assoc()) {
                                                                    $seguimiento = $fila['seguimiento_nombre'];
                                                                    $total_seguimientos = $fila['total_seguimientos'];
                                                                    echo '<tr>
                                                                    <td>' . $seguimiento . '</td>
                                                                    <td class="denied">' . $total_seguimientos . '</td>
                                                                </tr>';
