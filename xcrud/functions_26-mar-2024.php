...
mysqli_set_charset($conn, "utf8");
    ...
    $usuarioars = $_SESSION["usuarioars"];
    $ip = $_SERVER["REMOTE_ADDR"];
    
    $qry1 = "INSERT INTO logs2 (l_nombre, l_tiempo, l_usuario, l_ip) 
         VALUES ('$nombres', CURRENT_TIMESTAMP,'$usuarioars','$ip')";

    $cs3 = mysqli_query($conn, $qry1);
}
