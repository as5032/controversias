...
<?php if ($this->is_create or $this->is_csv or $this->is_print){?>
      ...
      <div class="row" style="margin: 0!important;overflow-x: scroll;padding-bottom: 50px;">

        <?php

        if($this->advanced_search_position == "left"){
            echo "<div class='col-md-3' style='position:absolute;'>";
            echo $this->render_advanced_filter();
            echo "</div>"; 
        } 
        ...
        <div class="xcrud-list-container <?php if($this ->is_edit_side){ echo ' fl'; } if($this->advanced_search_position == "left" && $this->advanced_search_opened == true){ echo 'col-md-9 fr'; }else{ echo 'col-sm-12'; } ?>">
