<?php /** Configuration file; Patrick xCRUD v.1.7.17; 03/2015 */
class Xcrud_config
{
    // default connection
    ...
    // theme and language
    public static $theme = 'bootstrap4'; // can be 'default', 'bootstrap','bootstrap4' or 'bootstrap5', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
    public static $language = 'es2'; // sets default localization
    ...
    public static $session_error_message = "<a href='javascript:location.reload()'>Refresh Page</a><br><strong>The verification key is out of date</strong><br />
    ...
    public static $load_bootstrap4 = true; // turn on, if you want to load bootstrap 4 via xCRUD
    public static $load_bootstrap5 = false; // turn on, if you want to load bootstrap 5 via xCRUD
    public static $load_semantic = false;
	...
	//load videojs
	public static $load_videojs = false;
    ...
    public static $upload_folder_def = '../documentos'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
	...
	public static $map_key = '';
	public static $google_map_api = '';
    ...
    public static $autoclean_timeout = 30000000; // in seconds. Do not change, if not sure. Xcrud clears old instances in session when you reload browser tab or open new tab with xcrud. In this case Xcrud can't work in two tabs in the same time. You can increase timeout on your risk.
    public static $autoclean_activate = true;// deactivate multi instance checks. if false means you can now use multiinstance or open multiple instances in different tabs without an issue
    ...
    public static $mail_host = 'mail.xcrud.net';
    public static $mail_port = 587;
    public static $smtp_auth = true;
    public static $username = 'sales@xcrud.net';
    public static $password = '';
    public static $emailfrom = 'xCrud team';
    public static $smtpsecure = 'tls';

    //blue imp file uploader
    public static $load_filuploader = false;
    public static $blue_imp_server = "../xcrud/plugins/jQuery-File-Upload-master/server/php/";

    public static $search_on_typing = false;

    //public static $enable_advanced_search = false;
